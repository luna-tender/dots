...
-- delete/put without yanking
map({ "n", "v" }, "<leader>d", '"_d', { desc = "Delete Without Yank", noremap = true, silent = true })
map("x", "p", "P", { desc = "Put Without Yank", noremap = true, silent = true })
